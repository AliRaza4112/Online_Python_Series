...
names = "Ali" , "Ahmed", "Muntazir" , 19 , 10 , 15 , True , False , False
# names[0] = "Mutazir"  # This will raise an error
# print(names)
...
# Accessing values
myself = "Ali" , 19 , True , "Developer" , "Pakistan" , "Islamabad", "Reading" , "Traveling" ,"Coding" , "Gaming"
# print(myself[2])
# print(myself[1 : 4])
...
tuple1 = (1,2,3 ,4,5,6,7,7,"Ali",9,10)
tuple2 = (4,5,6)
# print(tuple1 * 3)
# print(tuple1 + tuple2)
...
# unpacking tuple 
myself1 = (19 , "Ali" , True , "Developer" , "Pakistan" , "faisalabad", "Reading" , "Traveling" ,"Coding" , "Gaming")
name , age , is_student , profession , country , city , hobby1 , hobby2 , hobby3 , hobby4 = myself1

print(name)

myself2 = "Ali",  19, True , "Developer" , "Pakistan" , "sukkur", "Reading" , "Traveling" ,"Coding" , "Gaming"
